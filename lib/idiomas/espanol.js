...
//AVISOS DE MENSAJE
const smsAvisoRG = () => { return `𝗦𝘂𝗽𝗲𝗿𝗶𝗼𝗿𝗶𝘁𝘆 𝗕𝗼𝘁\n\n` }
const smsAvisoAG = () => { return `𝗦𝘂𝗽𝗲𝗿𝗶𝗼𝗿𝗶𝘁𝘆 𝗕𝗼𝘁\n\n` }
const smsAvisoIIG = () => { return `𝗦𝘂𝗽𝗲𝗿𝗶𝗼𝗿𝗶𝘁𝘆 𝗕𝗼𝘁\n\n` }
const smsAvisoFG = () => { return `𝗦𝘂𝗽𝗲𝗿𝗶𝗼𝗿𝗶𝘁𝘆 𝗕𝗼𝘁\n\n` }
const smsAvisoMG = () => { return `𝗦𝘂𝗽𝗲𝗿𝗶𝗼𝗿𝗶𝘁𝘆 𝗕𝗼𝘁\n\n` }
const smsAvisoEEG = () => { return `𝗦𝘂𝗽𝗲𝗿𝗶𝗼𝗿𝗶𝘁𝘆 𝗕𝗼𝘁\n\n` }
const smsAvisoEG = () => { return `𝗦𝘂𝗽𝗲𝗿𝗶𝗼𝗿𝗶𝘁𝘆 𝗕𝗼𝘁\n\n` }
...
//main.js
const smsWelcome = () => { return '*𝗦𝘂𝗽𝗲𝗿𝗶𝗼𝗿𝗶𝘁𝘆 𝗕𝗼𝘁*\n\n*𝗕𝗶𝗲𝗻𝘃𝗲𝗻𝗶𝗱𝗼 𝗔𝗹 𝗚𝗿𝘂𝗽𝗼 𝗥𝗲𝘆 @user*'}
const smsBye = () => { return '*𝗦𝘂𝗽𝗲𝗿𝗶𝗼𝗿𝗶𝘁𝘆 𝗕𝗼𝘁*\n\n*𝗙𝘂𝗲𝗿𝗮 @user 𝗡𝗶 𝗗𝗲 𝗔𝗱𝗼𝗿𝗻𝗼 𝗡𝗼𝘀 𝗦𝗲𝗿𝘃𝗶𝘀𝘁𝗲𝘀 𝗝𝗔𝗝𝗔 *'}
...
const eGataCoins = () => { return '🪙 SupeCoins' }
const eGataTickers = () => { return '🎫 Supe Tickers' } 
...
const smsBCbot7 = () => { return `𝗦𝘂𝗽𝗲𝗿𝗶𝗼𝗿𝗶𝘁𝘆 𝗕𝗼𝘁`}

//propietario(a).js
const smsChatGP1 = () => { return "*Enviando mensaje, espere un momento...*"}
const smsChatGP2 = (readMS, dia, mes, año, fecha, tiempo) => { return `𝗦𝘂𝗽𝗲𝗿𝗶𝗼𝗿𝗶𝘁𝘆 𝗕𝗼𝘁\n${readMS}\n\`\`\`${dia}, ${mes} ${año}\`\`\`\n\`\`\`${fecha} || ${tiempo}\`\`\`\n\n`}
